...
- AstrBot 版本：`>=4.22.0`
- 编码要求：UTF-8
- 维护状态：5.1.0 继续收敛主动主链路和历史配置包袱，主动消息从“堆提示词写正文”转向规划、判定、自检、执行分层协作。后续进入持续人格维护 + 体验打磨阶段。
...
- 自登记屏蔽词：可为关系网自登记单独配置屏蔽词和命中后的回复文案，拦截整活称呼、冒领称呼或不想收录的自报名字。
