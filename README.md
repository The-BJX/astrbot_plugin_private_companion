...
- AstrBot 版本：`>=4.22.0`
- 编码要求：UTF-8
- 维护状态：5.3.7 收束被动回复、生图预设、Token 概览和扩展页配置体验；默认行为保持稳，公开回复和主动图片能力仍建议按需开启。
...
6. 如果只想让 Bot 偶尔主动来找你，不希望它参与普通被动回复，可以开启“关闭被动能力”。开启后普通私聊/群聊注入、图片/转发处理、防抖、群聊观察、TTS 后处理等会被锁定覆盖；关闭该模式后原配置会恢复生效。
